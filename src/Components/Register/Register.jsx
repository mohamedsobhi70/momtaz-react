            ...
            <div className="h-full px-[30px] lg:px-[100px] flex flex-col lg:justify-center lg:gap-8">
                ...
                <div className="flex flex-col gap-2 lg:gap-3 py-6 lg:py-0">
                    ...
                    <p className="text-[#667085] text-sm lg:text-base leading-normal lg:leading-normal font-medium">
                        من فضلك أضف بياناتك حتي يمكننا الأستمرار.
                    </p>
                </div>
                ...
                <form onSubmit={handleLogin}>
                    <div className="flex flex-col lg:gap-6">
                        <div className="flex flex-col gap-4 lg:gap-8 py-4 lg:py-0">
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="phone-num" className="text-[#4A5578] text-xs leading-normal font-medium">
                                    رقم الهاتف
                                </label>
                                <div className="relative">
                                    <img src={phoneIcn} width="20" height="20" alt="username"
                                        className="absolute right-3 top-1/2 -translate-y-1/2" />
                                    <input type="text" name="phone-num" id="phone-num" placeholder="123xxxxx" required className="input-sm inpt-primary w-full" />
                                </div>
                            </div>
